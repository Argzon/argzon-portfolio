...
export default function Coherent() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "strategy", label: "Strategy & Approach" },
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-8 md:flex-row md:gap-16">
              <p className="subtitle">
                ...
                effectively tells Coherent&apos;s story while enhancing
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              innovative approach. The website needed to strike a balance
              between technical depth and user-friendly content, ensuring an
              intuitive browsing experience. Additionally, it had to
              differentiate Coherent from competitors in a crowded market with a
              well-structured and engaging narrative.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl w-full mx-auto flex flex-col gap-16 px-4 md:px-10 lg:px-0">
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            <h3>4. UI Design</h3>
            <p>
              Designed high-fidelity UI screens with an emphasis on clean,
              modern aesthetics.
            </p>
          </div>
          <BeforeAndAfter />
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              iterative improvements based on feedback. Key collaboration
              points:
            </p>
            <div className="flex flex-col gap-4">
          ...
          <div className="w-full bg-[#6700F6] rounded-2xl px-8 py-16 md:p-16 lg:py-40 lg:pl-48 overflow-hidden relative">
            <div className="lg:max-w-lg flex flex-col gap-2.5">
              <p className="subtitle italic text-white-100 ">
                ...
                ability to translate our vision into a user-friendly and
                visually compelling website exceeded our expectations. From the
                initial research phase to the final design delivery, he
                demonstrated creativity, attention to detail, and a deep
                understanding of our brand&apos;s needs. The new website not
                only reflects our company&apos;s mission but also provides an
