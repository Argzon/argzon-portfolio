...
export default function Creatick() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "userpainpoints", label: "User Pain Points" },
      { id: "research", label: "Research & Strategy" },
      { id: "approach", label: "Approach" },
      { id: "implementation", label: "Implementation" },
      { id: "impact", label: "Final Solution" },
    ],
    []
  );
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-8 md:flex-row md:gap-16">
              <p className="subtitle">
                ...
                platform, showcasing my end-to-end design and development
                process, from research to execution. This project highlights
                UX/UI design, front-end development, and agile methodologies to
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              Creatick is an all-in-one social media management platform
              designed to simplify Instagram content planning, scheduling, and
              analytics. It caters to both individual creators and businesses,
              providing a seamless solution to streamline social media
              strategies.
            </p>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            <h3>My Role</h3>
            <p>
              As the lead UI/UX Designer and Frontend Developer, I was
              responsible for:
            </p>
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              I designed moodboards to establish the visual direction and
              created low-fidelity wireframes to map out the user journey before
          ...
          <div className="w-full brand-light rounded-2xl px-8 py-16 md:p-16 lg:py-40 lg:pl-48 overflow-hidden relative">
            <div className="lg:max-w-lg flex flex-col gap-2.5">
              <p className="subtitle italic text-white-100 dark:text-black-600">
                ...
                research to design to development, he truly understood our
                vision and transformed it into an intuitive, high-performing
                platform. The UI is sleek, the UX is seamless, and our users
                love the experience. We couldn&apos;t have asked for a better
                partner in bringing Creatick to life!&quot;
              </p>
          ...
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              <span className="font-bold">
                challenging yet rewarding project
              </span>{" "}
              that pushed the boundaries of design and development. Through a
              research-driven approach, seamless UX, and agile execution, we
              built a platform that empowers users to manage their Instagram
