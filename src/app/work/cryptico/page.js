...
export default function Cryptico() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "finaloutcome", label: "Final Outcome" },
    ],
    []
  );
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
        ...
        <div className="hero max-w-7xl w-full mx-auto flex flex-col gap-16 px-4 md:px-10 lg:px-0">
          <div className="flex flex-col gap-8">
            <h1>
              Cryptico: Transforming Crypto Trading with an Intuitive Web &
              Mobile Experience
            </h1>
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              that not only showcased Cryptico&apos;s services but also engaged
              a diverse audience of crypto traders, from beginners to seasoned
              professionals.
            </p>
            <p>
              As the{" "}
        ...
        <div
          id="challenge"
          className="max-w-[844px] w-full mx-auto flex flex-col gap-8 px-4 md:px-10 lg:px-0"
        >
          <h2>The Challenge</h2>
          ...
          <p>
            ...
            performance while maintaining a sleek, modern interface that
          ...
          >
            <div className="lg:max-w-lg flex flex-col gap-2.5">
              <p className="subtitle italic text-black-600">
                ...
                expectations. The user experience is now seamless, and the
                design truly sets us apart in the industry. Working with Argzon
                was a fantastic experience, and we highly recommend their
                expertise.&quot;
              </p>
