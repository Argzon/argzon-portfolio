...
export default function Krado() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "designprocess", label: "Design Process & Solutions" },
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              user experience, integrate engaging animations, optimize
              navigation, and enhance mobile responsiveness while maintaining
              the brand&apos;s essence. I collaborated with a Webflow developer
        ...
        >
          ...
          <div className="w-full flex items-center justify-center bg-green-400 rounded-2xl p-6 md:p-8">
            <Image
              src={
                "/assets/portfolio-images/krado/information-architecture.svg"
              }
              height={612}
              width={1200}
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              A modern and{" "}
              <span className="font-bold">minimalistic design</span> was
              implemented to reflect Krado&apos;s innovation. Key elements
              included:
            </p>
            <div className="flex flex-col gap-4">
          ...
          <div className="w-full green-light rounded-2xl px-8 py-16 md:p-16 lg:py-40 lg:pl-48 overflow-hidden relative">
            <div className="lg:max-w-lg flex flex-col gap-2.5">
              <p className="subtitle italic text-white-100 dark:text-black-600 dark:black-600">
                &quot;The website redesign exceeded our expectations. The
                improved user experience and seamless navigation have
                significantly increased engagement. The animations beautifully
                showcase our product, and we couldn&apos;t be happier with the
                results!&quot;
              </p>
