...
export default function Nelta() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "solution", label: "Research & Strategy" },
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              healthcare, and government. They specialize in software testing,
              CRM consulting, SAP consulting, and custom software development.
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              challenge was to highlight their unique offerings and
              differentiate them in a competitive market while ensuring an
              intuitive and engaging user experience.
            </p>
            <p>
              They approached me with a vision to transform their outdated
              website into a high-performing marketing platform that would:
            </p>
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            <h2>The Solution</h2>
            <p>
              A comprehensive approach was taken to create a visually engaging
              and user-friendly website. I conducted thorough research to
              understand the target audience, ensuring a user-centric design.
            </p>
            <h3 id="research">Research & Strategy</h3>
            <div className="flex flex-col gap-4">
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              iteratively with the team to adapt quickly to changing
              requirements. Regular sprints and feedback loops ensured
              flexibility and efficiency, ultimately delivering a dynamic and
