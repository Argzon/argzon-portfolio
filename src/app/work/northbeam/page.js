...
export default function Northbeam() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "wireframing", label: "Wireframing & UX Design" },
      ...
      <div className="flex flex-col gap-[150px] md:gap-[200px]">
        ...
        <div className="flex items-center justify-center pt-10">
          <div className="flex justify-center lg:justify-between items-center max-w-7xl w-full mx-auto fixed z-[100] px-10 lg:px-0 pt-10">
            ...
            <Navigation />
            <a
              href="/work/talentally"
              onClick={(e) => {
                e.preventDefault();
                router.push("/work/talentally", {
                  onTransitionReady: slideInOut,
                });
              }}
              className="label text-black-100 border border-white-300 dark:border-black-300 px-4 py-3 rounded-full hidden lg:flex flex-row gap-1 shrink-0 hover:text-black-200 dark:hover:text-white-200 hover:border-white-400 dark:hover:border-black-400 hover:bg-white-200 dark:hover:bg-black-400 transition-all duration-300"
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              ...
              businesses make informed marketing decisions. However, their
              website didn&apos;t reflect their innovative approach, lacking a
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            <h2>The Challenge</h2>
            <p>
              Despite Northbeam&apos;s powerful technology, their website
              suffered from several key issues:
            </p>
            ...
            <p>
              The challenge was to overhaul the website, improve the user
              journey, and create a frictionless experience that encourages
              sign-ups.
            </p>
          </div>
          {/* Before & After */}
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              These insights laid the foundation for a streamlined, intuitive
              user experience that prioritizes conversions.
            </p>
          </div>
          {/* User Personas */}
        ...
        >
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              To align the website with Northbeam&apos;s innovative positioning,
              I crafted a clean, modern UI:
            </p>
            <div className="flex flex-col gap-4">
              <Label
          ...
          <div className="w-full flex flex-col gap-8">
            ...
            <div className="w-full flex items-center justify-center bg-white-200 dark:bg-black-400 rounded-2xl p-6 md:p-8">
              <Image
                ...
                placeholder="blur"
                blurDataURL={
                  "/assets/portfolio-images/northbeam/moodboard-2.jpg"
                }
                sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw"
              />
            </div>
            ...
            <div className="w-full flex items-center justify-center bg-blue-100 rounded-2xl p-6 md:p-8">
              <Image
                ...
                placeholder="blur"
                blurDataURL={
                  "/assets/portfolio-images/northbeam/ds-buttons.svg"
                }
                sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw"
              />
            </div>
        ...
        >
          ...
          <div className="w-full flex items-center justify-center bg-blue-400 rounded-2xl p-6 md:p-8">
            <Image
              ...
              placeholder="blur"
              blurDataURL={
                "/assets/portfolio-images/northbeam/ds-components.svg"
              }
              sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw"
            />
          </div>
        ...
        <div className="max-w-7xl w-full mx-auto flex flex-col gap-16 px-4 md:px-10 lg:px-0">
          <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
            ...
            <p>
              This project reinforced the importance of aligning UX/UI design
              with business goals. By prioritizing usability, clarity, and
              engagement, I helped Northbeam create a digital experience that
          ...
          <div className="w-full bg-blue-200 rounded-2xl px-8 py-16 md:p-16 lg:py-40 lg:pl-48 overflow-hidden relative">
            <div className="lg:max-w-lg flex flex-col gap-2.5">
              <p className="subtitle italic text-black-600 ">
                ...
                Northbeam&apos;s innovative technology. From the initial
                research phase to the final UI design, he led the entire
                process, creating the sitemap, wireframes, and high-fidelity
                designs that streamlined the user journey and improved
                conversions. His ability to combine modern aesthetics with
                user-centered design helped us deliver a more engaging
                experience for marketing professionals, making self-serve
                conversions asier than ever.&quot;
              </p>
