      ...
      <div className="max-w-7xl w-full mx-auto flex flex-col gap-16 px-4 md:px-10 lg:px-0">
        <div className="flex flex-col gap-8 max-w-[844px] w-full mx-auto">
          ...
          <p>
            ...
            Women (IAW) and RemoteMore USA. Founded in 2008 and publicly traded
            since 2013 (NASDAQ: IPDN), TalentAlly provides online professional
            networking communities with career resources tailored to diverse
            cultural groups.
          </p>
          <p>
          ...
          <div className="lg:max-w-[694px] flex flex-col gap-2.5">
            <div className="flex flex-col gap-2">
              ...
              <p className="subtitle italic text-white-100">
                ...
                contributing to the project&apos;s overall success. His ability
                to keep the design process streamlined and on track was
              ...
              <p className="subtitle italic text-white-100">
                Finally, one of the most enjoyable aspects of working with Argi
                was his positive attitude and collaborative spirit. His
